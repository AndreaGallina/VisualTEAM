...
Java_it_unipd_dei_esp1617_visualize_CaffeMobile_setNumThreads(JNIEnv *env,
                                                             jobject thiz,
                                                             jint numThreads) {
...
JNIEXPORT void JNICALL Java_it_unipd_dei_esp1617_visualize_CaffeMobile_enableLog(
    JNIEnv *env, jobject thiz, jboolean enabled) {}

JNIEXPORT void JNICALL Java_it_unipd_dei_esp1617_visualize_CaffeMobile_loadModel(
...
JNIEXPORT void JNICALL
Java_it_unipd_dei_esp1617_visualize_CaffeMobile_setMeanWithMeanFile(
...
JNIEXPORT void JNICALL
Java_it_unipd_dei_esp1617_visualize_CaffeMobile_setMeanWithMeanValues(
...
JNIEXPORT void JNICALL Java_it_unipd_dei_esp1617_visualize_CaffeMobile_setScale(
...
Java_it_unipd_dei_esp1617_visualize_CaffeMobile_getConfidenceScore(
...
Java_it_unipd_dei_esp1617_visualize_CaffeMobile_predictImage(
    JNIEnv *env, jobject thiz, jbyteArray buf, jint width, jint height,
    jint k) {
  CaffeMobile *caffe_mobile = CaffeMobile::Get();
  vector<int> top_k =
...
Java_it_unipd_dei_esp1617_visualize_CaffeMobile_extractFeatures(
    JNIEnv *env, jobject thiz, jbyteArray buf, jint width, jint height,
    jstring blobNames) {
  CaffeMobile *caffe_mobile = CaffeMobile::Get();
